...
eq(snap.changes[0].id, "o1", "change orders carry their id so the portal can record an approval");
eq(snap.changes[1].id, "o3", "pending change order id is the approvable reference");
ok(!json.includes('"o2"'), "voided change orders and their ids are never exposed");
